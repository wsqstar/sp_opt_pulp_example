...
def p_median_algorithm(SouthCarolina_shp, P_RELOCATED=3, fixed_facilities=[]):
    """
...
def main():
    ...
    # 调用函数并绘制结果
    P_RELOCATED = 4
    fixed_facilities = [0, 1, 2]  # 固定前三个设施不动
    rslt, fac_loc = p_median_algorithm(SouthCarolina_shp, P_RELOCATED, fixed_facilities)
